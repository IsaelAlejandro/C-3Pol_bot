...
%
% The case dz=df=0,rx = 0 corresponds to a single DSF basis centered at (x, y,z,d) = (0, 0,0,0).
%
...
df=0; %distance between coverslip and focal plane in microns.  it can be a vector
%% Spatial coordinates%%%%%%%%%%%%%%
rx=0;  %it can be a vector, In pixel units.
...
%%%%%%%%%%%%%%%%% Do not change: Initial Parameters %%%%%%%%%%%%%%%%%
